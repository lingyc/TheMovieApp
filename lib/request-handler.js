...
//outputs: {user2id: 'id', friendName:'name', title:'movieTitle', score:n }
	...
	.then(function(friendsRatings){
		return Promise.map(friendsRatings.models, function(friendRating) {
			...
			.then(function(friend){
				friendRating.attributes.friendName = friend.attributes.username;
				return friendRating;
			});
		});
	})
	.then(function(friendsRatings){
		console.log('getFriendRatings', friendsRatings);
...
var getOneMovieRating = function(username, movieTitle, movieObj) {
  ...
  .then(function(rating){
  	...
  	console.log(username, movieTitle);
