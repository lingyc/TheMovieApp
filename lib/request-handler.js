...
// if req.query.friendName is provided, will get all the friend's ratings, otherwise will default to getting ratings for the current user
exports.getUserRatings = function(req, res) {
  Rating.query(function(qb){
  	...
  	qb.where('users.username', '=', (req.query.friendName || req.mySession.user));
